...
public partial class RewindableStateMachine : Node
{
	...
	public void Transition(StringName newStateName)
	{
		...
		{
			GD.PushWarning($"Attempted to transition from state {State} to" +
	...
	public override void _Notification(int what)
	{
		...
		if (what == NotificationReady)
		{
			...
			NetfoxCs.NetworkTime.Connect(NetworkTime.SignalName.AfterTickLoop, Callable.From(AfterTickLoop));
		}
	}
	...
	private void SetState(string newState)
	{
		...
		{
			GD.PushWarning($"Attempted to set unknown state: {newState}");
			return;
		}

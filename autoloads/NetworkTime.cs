...
public partial class NetworkTime : NodeWrapper<Node>
{
	protected override StringName GdClassName => "_NetworkTime";
 #region Public Variables
    ...
    /// <summary><para>Progress towards the next tick from 0 to 1, where 0 is the start
    ...
    public static double LocalTime => (double)_networkTimeGd.Get(PropertyNameGd.LocalTime);
    ...
    /// you need a signal, see <see cref="Netfox.NetworkTime.AfterSync"/>.</para></summary>
    ...
    private static class SignalNameGd
    {
        public static readonly StringName
